...
import { SaleTransactionPage } from '../pages/SaleTransactionPage';
import { TransactionSummaryPage } from '../pages/TransactionSummaryPage';
import { generateTestData } from '../utils/createTestData';
...
test.describe('Verify Transaction Form submition', () => {
  ...
  test('Verify submition transaction should show error message when no inputing', async () => {
    ...
    await saletransactionPage.verifyTransactionErrorMessages(
      test,
      expect,
  ...
  test('Verify submition transaction should show error message when invalid inputing', async () => {
    const testData = generateTestData({
    ...
    await expect(saletransactionPage.buyerEmailError).toHaveText(
      errorMessages.invalidFields.invalidEmail
    );
    await expect(saletransactionPage.buyerPhoneError).toHaveText(
      errorMessages.invalidFields.invalidPhoneNumber
    );
    await expect(saletransactionPage.fileNameError).toHaveText(
      errorMessages.invalidFields.invalidFileName
    );
